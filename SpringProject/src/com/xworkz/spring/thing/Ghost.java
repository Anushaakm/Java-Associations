...
public class Ghost {
	...
	@Autowired
	public Ghost(@Qualifier("ghostName") String ghostName,@Qualifier("ghostLastName") String ghostLastName, @Qualifier("ghostAge")int ghostAge,@Qualifier("deathDate") LocalDate deathDate,@Qualifier("ghostLocation") String ghostLocation,
			@Qualifier("isScary") boolean isScary,@Qualifier("ghostFriendName") String ghostFriendName,@Qualifier("ghostFavFood") String ghostFavFood,@Qualifier("ghostFavSports") String ghostFavSports,@Qualifier("gender") String gender) {
		super();
	...
	public String toString() {
		return "Ghoast [ghostName=" + ghostName + ", ghostLastName=" + ghostLastName + ", ghostAge=" + ghostAge
				...
				+ ", hasLover=" + hasLover + ", numberOfLegs=" + numberOfLegs + ", isSucide=" + isSucide + ", bad=" + bad
