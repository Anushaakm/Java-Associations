...
public class Runner {
	...
	public static void main(String[] args) {
		...
		Currency currenacy2 = new Currency("Yuan",11.43,"China","green",true,"Renminbi",15,"china",5678.9,true);
		...
		God god2=new God("Lakshmi","Lakshmi",1000,"na","Bengaluru",19380193,"ramachari",456.66,true,"Monday");
		...
		Lipstick lipstick = new Lipstick("mat",350,"huda","pink",true,"Anusha","new","bengaluru","Red Bull","xyz");
		System.out.println(lipstick);



		Lipstick lipstick2 = new Lipstick("mat",350,"huda","pink",true,"Anusha","new","bengaluru","Red Bull","xyz");
