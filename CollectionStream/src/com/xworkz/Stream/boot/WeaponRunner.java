...
public class WeaponRunner {
	...
	public static void main(String[] args) {
		...
		dto.add(new WeaponDTO("ICBM", "LIKKI", LocalDate.of(2001, 01, 3), 987D, WeaponType.MISSILES));
		dto.add(new WeaponDTO("LANCE MISSILE", "LAVANYA", LocalDate.of(2002, 01, 4), 876D, WeaponType.MISSILES));
		...
		dto.add(new WeaponDTO("DEPTH CHARGE", "CHAITANYA", LocalDate.of(2005, 01, 7), 576D, WeaponType.BOMBS));
		dto.add(new WeaponDTO("GRENADE", "BHOOMIKA", LocalDate.of(2006, 01, 8), 1239D, WeaponType.BOMBS));
		...
		dto.add(new WeaponDTO("AntiAircraft gun", "Raj", LocalDate.of(2022, 12, 15), 12764D, WeaponType.ARTILLERY));
		dto.add(new WeaponDTO("Paris Gun", "Paris", LocalDate.of(2021, 11, 04), 45897D, WeaponType.ARTILLERY));
		...
		dto.add(new WeaponDTO("Daggar", "rax", LocalDate.of(1968, 1, 14), 12764D, WeaponType.COMBAT_WEAPONS));
		...
		dto.add(new WeaponDTO("Yellow rain", "shaaam", LocalDate.of(2022, 12, 8), 12764D,WeaponType.BIOLOGICAL_WEAPONRY));
