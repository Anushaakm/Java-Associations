		...
		<div>
			<div class="mb-3">
				<label for="exampleFormControlInput1" class="form-label">Beach
					...
					id="exampleFormControlInput1" placeholder="Enter Beach Name  Name"
					name="name">
			</div>
			...
			<div class="mb-3">
				<label for="exampleFormControlInput1" class="form-label">Clean:
					Yes </label> <input type="radio" name="clean" value="true" /> No <input
					type="radio" name="clean" value="flse" />
			</div>
